...
def customer_summary(Network_Path,Case):
    ...
    if Case[4:]=='75HP':
        Customer_Summary["Acorn_Group"][::8] = "Adversity"    
        Customer_Summary["Acorn_Group"][4::8] = "Comfortable"
        Customer_Summary["Acorn_Group"][1::4] = "Affluent"
        Customer_Summary["Acorn_Group"][2::4] = "Affluent"
        Customer_Summary["Acorn_Group"][3::4] = "Affluent" 
    
    if Case[5:]=='100HP' or Case[4:]=='100HP':
        Customer_Summary["Acorn_Group"] = "Affluent"
    
    Customer_Summary["PV_kW"][Customer_Summary["Acorn_Group"] == "Affluent"] = choice(pvcaplist, int(sum(Customer_Summary["Acorn_Group"] == "Affluent")), weights)
    ...
    if Case=='25PV50HP':
        Customer_Summary["PV_kW"]=0
        affs=Customer_Summary["PV_kW"][Customer_Summary["Acorn_Group"] == "Affluent"]
        affs[1::2] = choice(pvcaplist, int(sum(Customer_Summary["Acorn_Group"] == "Affluent")/2), weights)
        Customer_Summary["PV_kW"].loc[affs.index]=affs

    if Case=='25PV75HP':
        Customer_Summary["PV_kW"]=0
        affs=Customer_Summary["PV_kW"][Customer_Summary["Acorn_Group"] == "Affluent"]
        affs[2::3] = choice(pvcaplist, int(sum(Customer_Summary["Acorn_Group"] == "Affluent")/3), weights)
        Customer_Summary["PV_kW"].loc[affs.index]=affs        
