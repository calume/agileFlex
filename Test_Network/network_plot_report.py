...
def customer_summary(Network_Path,Case):
    ...
    fcolor = ["red", "brown", "blue", "orange", "green", "#17becf", "black","grey","purple"]
...
def Network_plot(Coords, Lines, Loads, Customer_Summary):
    ...
    for i in Loads.index:
        ...
        #     )
        #     ax.add_artist(ab)
        offset = [0, 8, 16, 24, 32, 40,48,56,48,54]
    ...
    #     )
    fcolor = ["red", "brown", "blue", "orange", "green", "#17becf", "black","grey","purple"]
    plt.annotate("Feeder", (560, 215), fontsize=10, color="black", weight="bold")
    ...
    plt.annotate("Legend", (25, 645), fontsize=10, color="black", weight="bold")
    plt.annotate(intros[0], (50, 570), fontsize=9, color="black")
    ab = AnnotationBbox(boxes[0], [35, 585], frameon=False, pad=0)
    ax.add_artist(ab)

    ab = AnnotationBbox(boxes[0], [Coords['X'][0], Coords['Y'][0]], frameon=False, pad=0)
    ax.add_artist(ab)
...
####### Network 10 settings 
    ...
    # plt.annotate("Feeder", (160, 90), fontsize=10, color="black", weight="bold")
    # for i in Customer_Summary['Feeder'].unique().astype(int):
    #     plt.annotate(
    #         i,
    #         (160, 85 - offset[i] * 3),
    ...
    #     "Secondary \nSubstation",
    # ]
    # plt.annotate("Legend", (160, 190), fontsize=10, color="black", weight="bold")
    # plt.annotate(intros[0], (170, 165), fontsize=9, color="black")
    # ab = AnnotationBbox(boxes[0], [160, 175], frameon=False, pad=0)
    # ax.add_artist(ab)
